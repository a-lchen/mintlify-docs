...
<Note>
  Toute page dans le `snippets` le répertoire sera traité comme un extrait et ne sera pas rendu en tant que page autonome. Si vous souhaitez créer une page autonome à partir de l'extrait, importez l'extrait dans un autre fichier et appelez-le comme un composant.
</Note>
