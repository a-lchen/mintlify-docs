...
1. Ajoutez le contenu que vous souhaitez réutiliser à votre fichier d'extrait. En option, vous pouvez ajouter des variables qui peuvent être remplies via des props
...
<Warning>
  Le contenu que vous souhaitez réutiliser doit être dans le répertoire `snippets` pour que
...
<Warning>
  ...
  HTML quand vous le pouvez ou utilisez une exportation par défaut si vous devez utiliser MDX.
</Warning>
