...
1. Ajoutez le contenu que vous souhaitez réutiliser à travers plusieurs emplacements dans votre fichier d'extrait. En option, vous pouvez ajouter des variables qui peuvent être remplies via des props lors de l'importation de l'extrait.
