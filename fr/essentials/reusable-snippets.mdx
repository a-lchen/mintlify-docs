...
1. Ajoutez le contenu que vous souhaitez réutiliser à votre fichier d'extrait. Vous pouvez éventuellement ajouter des variables qui peuvent être remplies via des props lors de l'importation de l'extrait.
