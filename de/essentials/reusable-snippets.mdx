...
1. Fügen Sie Ihrem Snippet-File Inhalte hinzu, die Sie an mehreren Stellen wiederverwenden möchten. Optional können Sie Variablen hinzufügen, die beim Import des Snippets über Props ausgefüllt werden können.
