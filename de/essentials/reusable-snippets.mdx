...
1. Fügen Sie Inhalte zu Ihrer Snippet-Datei hinzu, die Sie an mehreren Stellen wiederverwenden möchten. Optional können Sie Variablen hinzufügen, die über Props ausgefüllt werden können, wenn Sie das Snippet importieren.
...
<Warning>
  MDX wird nicht innerhalb des Körpers einer Pfeilfunktion kompiliert. Halten Sie sich wenn möglich an HTML-Syntax oder verwenden Sie einen Standard-Export, wenn Sie MDX benötigen.
</Warning>
