...
<Warning>
  MDX wird nicht im Körper einer Pfeilfunktion kompiliert. Halten Sie sich wenn möglich an die HTML-Syntax oder verwenden Sie einen Standard-Export, wenn Sie MDX benötigen.
</Warning>
