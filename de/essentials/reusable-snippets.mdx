...
<Warning>
  MDX wird nicht innerhalb des Körpers einer Pfeilfunktion kompiliert. Halten Sie sich wenn möglich an die HTML-Syntax oder verwenden Sie einen Standard-Export, wenn Sie MDX benötigen.
</Warning>
