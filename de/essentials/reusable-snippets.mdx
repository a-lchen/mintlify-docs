...
1. Fügen Sie Ihrer Snippet-Datei Inhalte hinzu, die Sie an mehreren Stellen wiederverwenden möchten. Optional können Sie Variablen hinzufügen, die beim Import des Snippets über Props gefüllt werden können.
