...
<Warning>
  Der Inhalt, den Sie wiederverwenden möchten, muss sich innerhalb des`snippets` Verzeichnisses befinden, damit der Import funktioniert.
</Warning>
...
<Warning>
  MDX wird nicht im Body einer Pfeilfunktion kompiliert. Halten Sie sich wenn möglich an die HTML-Syntax oder verwenden Sie einen Standard-Export, wenn Sie MDX benötigen.
</Warning>
