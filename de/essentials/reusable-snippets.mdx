...
1. Fügen Sie Ihrer Snippet-Datei Inhalte hinzu, die Sie an mehreren Stellen wiederverwenden möchten. Optional können Sie Variablen hinzufügen, die über Props ausgefüllt werden können, wenn Sie das Snippet importieren.
